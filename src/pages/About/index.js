    ...
    <>
      <div className="container">
        ...
        <p>
          ...
          <br></br>
          <br></br>
          Sempre tive atração por criar e "dar vida" às idéias e por isso, em
          2014, escolhi a Engenharia Civil. Após alguns anos percebi que não era
          bem o que eu buscava, então tranquei o curso no 8° período. Com as
          experiências e conhecimentos de gerente em marmoraria, estudante de
        ...
        <p className="final-sentence">
          "Me encontrei e me realizo a cada dia no desenvolvimento front-end
          pois não só vejo a 'mágica' acontecer como também faço parte dela!"
        </p>
      </div>
    </>
  );
