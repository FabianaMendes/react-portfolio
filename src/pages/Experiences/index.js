      ...
      <div className="container">
        ...
        <div className="cards-experiences">
          ...
          <Card
            ...
            description={
              <p>
                ...
                <br></br>
                ·Realizar processos de admissão, treinamento e rescisão seguindo
                PPRA e PCMSO da empresa.
                <br></br>
                ·Comunicar afastamentos e suspensões e aplicar advertências.
                <br></br>
                ·Acompanhar e transcrever pontos manuais para cálculo de
                vale-alimentação, vale-transporte, horas extras, adicionais
                noturnos e banco de horas (média de 50 funcionários).
                <br></br>
                ·Fechamento de Folha de Pagamento para envio à contabilidade.
                <br></br>
                ·Controle de vencimento de férias, ASOs, CNHs, NRs e
                integrações.
                <br></br>
                ·Lançamento mensal de documentação Patronal e Funcional em
                sistemas/plataformas de clientes.
                <br></br>
                ·Recarga mensal de benefícios dos funcionários (vale-transporte,
                vale-alimentação).
                <br></br>
                ·Checar condições e realizar pedidos e entregas de uniformes,
                materiais de escritório e EPIs aos funcionários.
                <br></br>
                ·Responsável pela criação do plano de cargos e salários,
                correções de erros graves em folha de pagamento, criação de
                checklist de documentações, organização de pastas e arquivos
                físicos do RH da empresa, organização do arquivo digital do RH,
                criação de modelos de termos de responsabilidade, ordens de
                serviço e fichas, redução em 95% de pendência de documentos em
                plataformas.
              </p>
            }
          />
          ...
          <Card
            ...
            description={
              <p>
                ·Nya Senses: Estudo da cosmetologia natural e elaboração de
                fórmulas para diversos fins e tratamentos, incluindo
                hidratantes, sabonetes, tônicos, esfoliantes e máscaras.
                <br></br>
                ·WoodBox Brasil: Criação e desenho de peças decorativas e
                funcionais em madeiras diversas, cálculo e execução das
                peças(cortes, encaixes, preparação, montagem), estudo de tipos
                de materiais e indicações, finalizações, impermeabilização,
                lixação, envernizamento, encaixes, etc, manuseio de máquinas
                como serra de bancada, tupia, serra de mão, lixadeiras,
                tico-tico, pirógrafo, entre outras. Entre os modelos produzidos
                tivemos porta temperos, tábuas de corte, porta xícaras,
                prateleiras, estantes, porta chaves, nichos, quadros, objetos
